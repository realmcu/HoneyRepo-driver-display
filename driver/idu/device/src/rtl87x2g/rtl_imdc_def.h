...
typedef union
{
    ...
    struct
    {
        uint32_t imdc_reset_decompress_start: 1;
        uint32_t imdc_enable: 1;
        const uint32_t reserved_1: 6;
        uint32_t imdc_algorithm: 2;
...
#endif
        const uint32_t imdc_internal_buffer_empty: 1;
...
typedef union
{
    ...
    struct
    {
        const uint32_t imdc_output_counter: 32;
    } b;
...
typedef union
{
    ...
    struct
    {
        uint32_t imdc_decompress_error_int_en: 1;
        ...
        uint32_t imdc_decompress_finish_int_en: 1;
...
typedef union
{
    ...
    struct
    {
        uint32_t imdc_decompress_error_int_msk: 1;
        ...
        uint32_t imdc_decompress_finish_int_msk: 1;
        const uint32_t reserved_0: 25;
    } b;
} INT_MASK_TypeDef;
...
typedef union
{
    ...
    struct
    {
        const uint32_t imdc_decompress_error_int_raw_status: 1;
        ...
        const uint32_t imdc_decompress_finish_int_raw_status: 1;
        const uint32_t reserved_0: 25;
    } b;
...
typedef union
{
    ...
    struct
    {
        const uint32_t imdc_decompress_error_int_status: 1;
        ...
        const uint32_t imdc_decompress_finish_int_status: 1;
        const uint32_t reserved_0: 25;
    } b;
} INT_STATUS_TypeDef;
...
typedef union
{
    ...
    struct
    {
        uint32_t imdc_decompress_error_int_clr: 1;
        ...
        uint32_t imdc_decompress_finish_int_clr: 1;
        const uint32_t reserved_0: 25;
    } b;
} INT_CLEAR_TypeDef;
